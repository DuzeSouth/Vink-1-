        ...
        return(
            ...
            <div className="container" id="clock">
                ...
                <div className="container" id="break-time">
                    <button onClick={this.updateTimerLength} className="btns" id="break-increment"><i className="fa fa-sort-up fa-1x up-icon"></i></button>
                    <h6 id="break-label">Break Length:</h6>
                    <h6 id="break-length">{this.state.breakLength}</h6>
                    <button onClick={this.updateTimerLength}className="btns" id="break-decrement"><i className="fa fa-sort-down fa-1x down-icon"></i></button>
                </div>
                <div className="container" id="timer">
                    ...
                    <button onClick={this.startStopTimer} className="btns-timer" id="start_stop"><i className="fa fa-play fa-1x timer-icon"></i><i className="fa fa-pause fa-1x timer-icon"></i></button>
                    <button onClick={this.resetTimer} className="btns-timer" id="reset"><i className="fa fa-undo fa-1x timer-icon"></i></button>
                    <button onClick={this.snooze} className="btns-timer" id="snooze"><i className="fa fa-bell-slash fa-1x timer-icon"></i></button>
                </div>
                <div className="container" id="session-time">
                    <button onClick={this.updateTimerLength} className="btns" id="session-increment"><i className="fa fa-sort-up fa-1x up-icon"></i></button>
                    <h6 id="session-label">Session Length:</h6>
                    <h6 id="session-length">{this.state.sessionLength}</h6>
                    
                    <button onClick={this.updateTimerLength} className="btns" id="session-decrement"><i className="fa fa-sort-down fa-1x down-icon"></i></button>
                </div>
            </div>
